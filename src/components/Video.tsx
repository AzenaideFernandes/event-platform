  ...
  return (
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className=" flex items-start ga-16">
          <div className="flex-1 ">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              src="https://github.com/AzenaideFernandes.png" 
              alt="" />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Azenaide Fernandes</strong>
                <span className="text-gray-200 text-sm block">Engª da Computação</span>
              </div>
            </div>
          </div>
